...
import { privateKey } from "staging-sr-keys/private_key";
import { publicKey } from "staging-sr-keys/public_key";
...
const API_URL = "https://staging.eforestapi.com/api/sr/signature/verify ";
...
const index = () => {
  ...
  return (
    <>
      <div>
        <h3>Pay By Eforest- SR Staging</h3>
      </div>
      {response && (
        <div>
          <div>
